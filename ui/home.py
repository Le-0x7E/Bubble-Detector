...
"")
        ...
        self.Author.setStyleSheet(u"font: 10pt \"Segoe UI\";\n"
...
"}")
        ...
        self.explain_title.setFont(font1)
        self.explain_title.setStyleSheet(u"font: 700 16pt \"Segoe UI\";")
...
"}")
        ...
        self.Proportion_QF = QFrame(self.QF_Group)
        self.Proportion_QF.setObjectName(u"Proportion_QF")
        self.Proportion_QF.setMinimumSize(QSize(170, 80))
        self.Proportion_QF.setMaximumSize(QSize(170, 80))
        self.Proportion_QF.setToolTipDuration(0)
        self.Proportion_QF.setStyleSheet(u"QFrame#Proportion_QF{\n"
"color: rgb(255, 255, 255);\n"
"border-radius: 15px;\n"
"background-color: rgb(88, 88, 88);\n"
"border: 1px outset rgb(88, 88, 88)\n"
"}")
        self.Proportion_QF.setFrameShape(QFrame.StyledPanel)
        self.Proportion_QF.setFrameShadow(QFrame.Raised)
        self.verticalLayout_7 = QVBoxLayout(self.Proportion_QF)
        self.verticalLayout_7.setSpacing(0)
        self.verticalLayout_7.setObjectName(u"verticalLayout_7")
        self.verticalLayout_7.setContentsMargins(0, 0, 0, 0)
        self.Proportion_top = QFrame(self.Proportion_QF)
        self.Proportion_top.setObjectName(u"Proportion_top")
        self.Proportion_top.setStyleSheet(u"border:none")
        self.Proportion_top.setFrameShape(QFrame.StyledPanel)
        self.Proportion_top.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_6 = QHBoxLayout(self.Proportion_top)
        self.horizontalLayout_6.setSpacing(0)
        self.horizontalLayout_6.setObjectName(u"horizontalLayout_6")
        self.horizontalLayout_6.setContentsMargins(0, 3, 0, 3)
        self.label_5 = QLabel(self.Proportion_top)
...
"font: 700 16pt \"Segoe UI\";")
        ...
        self.verticalLayout_7.addWidget(self.Proportion_top)

        self.line_2 = QFrame(self.Proportion_QF)
        ...
        self.Proportion_bottom = QFrame(self.Proportion_QF)
        self.Proportion_bottom.setObjectName(u"Proportion_bottom")
        self.Proportion_bottom.setStyleSheet(u"border:none")
        self.Proportion_bottom.setFrameShape(QFrame.StyledPanel)
        self.Proportion_bottom.setFrameShadow(QFrame.Raised)
        self.verticalLayout_8 = QVBoxLayout(self.Proportion_bottom)
        self.verticalLayout_8.setSpacing(0)
        self.verticalLayout_8.setObjectName(u"verticalLayout_8")
        self.verticalLayout_8.setContentsMargins(0, 6, 0, 6)
        self.Proportion_num = QLabel(self.Proportion_bottom)
        self.Proportion_num.setObjectName(u"Proportion_num")
        self.Proportion_num.setMinimumSize(QSize(0, 30))
        self.Proportion_num.setMaximumSize(QSize(16777215, 30))
        font4 = QFont()
        ...
        self.Proportion_num.setFont(font4)
        self.Proportion_num.setStyleSheet(u"color: rgb(255, 255, 255);\n"
"font: 17pt \"Microsoft YaHei UI\";")
        self.Proportion_num.setAlignment(Qt.AlignCenter)

        self.verticalLayout_8.addWidget(self.Proportion_num, 0, Qt.AlignTop)


        self.verticalLayout_7.addWidget(self.Proportion_bottom)

        self.verticalLayout_7.setStretch(1, 2)
        self.verticalLayout_7.setStretch(2, 1)

        self.horizontalLayout_3.addWidget(self.Proportion_QF)
...
"font: 700 16pt \"Segoe UI\";")
        ...
        self.line_3.setStyleSheet(u"background-color: rgba(255, 255, 255, 255);")
...
"font: 700 16pt \"Segoe UI\";")
        ...
        self.line_4.setStyleSheet(u"background-color: rgba(255, 255, 255, 255);")
...
"font: 700 16pt \"Segoe UI\";")
        ...
        self.line_5.setStyleSheet(u"background-color: rgba(255, 255, 255, 255);")
...
"font: 17pt \"Microsoft YaHei UI\";")
        ...
        self.pre_video.setStyleSheet(u"background-color: rgb(228, 228, 228);\n"
"border:2px solid rgb(255, 255, 255);\n"
"border-radius:15px")
        self.pre_video.setScaledContents(False)
        ...
        self.res_video.setStyleSheet(u"background-color: rgb(228, 228, 228);\n"
"border:2px solid rgb(255, 255, 255);\n"
"border-radius:15px")
...
"color: rgba(0, 0, 0, 140);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Author.setText(QCoreApplication.translate("MainWindow", u"By BeileLiu", None))
        self.Title.setText(QCoreApplication.translate("MainWindow", u"\u6c14\u6ce1\u68c0\u6d4bGUI", None))
        self.ToggleBotton.setText(QCoreApplication.translate("MainWindow", u"\u663e\u793a/\u9690\u85cf", None))
        self.src_file_button.setText(QCoreApplication.translate("MainWindow", u"\u52a0\u8f7d\u6587\u4ef6", None))
        self.VersionLabel.setText(QCoreApplication.translate("MainWindow", u"Version: 1.3", None))
        self.explain_title.setText(QCoreApplication.translate("MainWindow", u"Bubble Detector", None))
        self.settings_button.setText("")
        self.min_sf.setText("")
        self.max_sf.setText("")
        self.close_button.setText("")
        self.char_label.setText("")
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"\u6c14\u6ce1\u5360\u6bd4(%)", None))
        self.Proportion_num.setText("")
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"\u6c14\u6ce1\u6570\u91cf(\u4e2a)", None))
        self.Target_num.setText("")
        self.label_7.setText(QCoreApplication.translate("MainWindow", u"\u5e27\u7387(fps)", None))
        self.fps_label.setText("")
        self.label_8.setText(QCoreApplication.translate("MainWindow", u"\u68c0\u6d4b\u6a21\u578b", None))
        ...
        self.ToggleBotton_6.setText(QCoreApplication.translate("MainWindow", u"\u68c0\u6d4b\u6a21\u578b", None))
        self.model_box.setPlaceholderText("")
        self.ToggleBotton_2.setText(QCoreApplication.translate("MainWindow", u"\u4ea4\u5e76\u6bd4IoU", None))
        self.ToggleBotton_3.setText(QCoreApplication.translate("MainWindow", u"\u7f6e\u4fe1\u5ea6Conf", None))
        self.ToggleBotton_4.setText(QCoreApplication.translate("MainWindow", u"\u5ef6\u8fdf(ms)", None))
        self.ToggleBotton_5.setText(QCoreApplication.translate("MainWindow", u"\u4fdd\u5b58\u7ed3\u679c", None))
        self.save_res_button.setText(QCoreApplication.translate("MainWindow", u"\u4fdd\u5b58 MP4/JPG", None))
        self.save_txt_button.setText(QCoreApplication.translate("MainWindow", u"\u4fdd\u5b58\u6807\u7b7e(.txt)", None))
